<footer class="bg-gradient-to-b from-gray-900 to-black border-t border-blue-500/30 py-8 mt-20">
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-4">
                <a href="#" class="w-10 h-10 bg-chrome rounded-lg flex items-center justify-center hover:bg-blue-600 transition-all duration-300 metallic-shine group">
        ...
        <div class="mt-6 pt-6 border-t border-blue-500/20 text-center">
            <p class="text-silver text-sm">
                Made with <span class="text-blue-400">❤️</span> by Kalong Pride Family
            </p>
        </div>
    </div>
</footer>
